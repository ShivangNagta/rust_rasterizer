...
fn main() -> Result<(), String> {
    ...
    let point2 = Point3D {
        vertex: Vertex { x: 50.0, y: 400.0, z: 0.0 },
    ...
    'running: loop {
        ...
        draw_interpolated_line(&mut canvas, point1.vertex.x as i32, point1.vertex.y as i32, point2.vertex.x as i32, point2.vertex.y as i32, c1, c2, 0.0, 0.0, resolution);
